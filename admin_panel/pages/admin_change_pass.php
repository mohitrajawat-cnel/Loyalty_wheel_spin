...
{//ramkishan
    ...
    $update_pass = "UPDATE ".$table_prefix."admin_login SET password = '".$password_new."' where id='1'"; 
    mysqli_query($conn,$update_pass);
    
    $save_msg = '<span style="color:green;">Password change successful.</span>';
}
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav aria-label="breadcrumb" style="position: absolute;right: 37px;margin-top: -35px;">
              ...
              <form class="form_data" method="post">
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="password" name="password_new" class="form-control" placeholder="enter password" required>
                  </div>
                </div>
          
                <div class="form-group mt-4">
                  <button type="submit" name="admin_update_password" class="btn btn-primary">Update</button>
                </div>
