      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
         <a href="../pages/users.php">
          <h6 class="font-weight-bolder mb-0">Contact Details List</h6>
         </a>
    ...
    <form method="post">
      <div class="container-fluid py-4">
        <div class="row">
                ...
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-2 pb-1">
                  <div class="row">
                    <div class="col-md-12 col-12 pt-2">
                      <h6 class="text-white text-capitalize ps-3" style="float:left;">Contact Details List</h6>
          ...
          <?php
//ramkishan
                  $select_user ="SELECT * from ".$table_prefix."contact_form  where 1=1 ";
                  ...
                  if(isset($_REQUEST['searchuser']))
                  {
                    /* $select_user .= " AND user_email LIKE '%".$_REQUEST["s"]."%' 
                      ...
                      */
                        ...
                        $select_user .= " AND `name` LIKE '%".$_REQUEST["s"]."%'; 
                        OR email LIKE '%".$_REQUEST["s"]."%'  
                        OR mobile_number LIKE '%".$_REQUEST["s"]."%'"; 
                  }
                  ...
                  while($result_user = mysqli_fetch_assoc($row_user))
                  {
                    ...
                    $mobile_number    =   $result_user['mobile_number'];
                    $description    =   $result_user['description'];
                    $created    =   strtotime($result_user['created']);

                    $form_submit_time = date("d-m-Y H:i:s",$created);
          ...
          ?>
                      ...
                      <tr class="text-center">
                        ...
                        <td><?php echo $form_submit_time; ?></td>
