...
if(isset($id) && $id !='')
{//ramkishan
   $delete ="UPDATE ".$table_prefix."phonenogenerate SET status='0' where id ='".$id."'";
  ...
  {
    $date_hwe = date("Y-m-d H:i:s");
    $insert_log ="INSERT into ".$table_prefix."admin_log SET click_status ='1',
    click_date='$date_hwe',
    admin='$id'";
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    if(isset($_POST['all_numbers_status_reset']))
    {
      
      $update_all_numbers_status = "UPDATE ".$table_prefix."phonenogenerate SET status='0'";
      mysqli_query($conn,$update_all_numbers_status);
          ...
          <div class="card my-4">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2 col-4 text-center">
                     ...
                     <form method="post">
                        ...
                        <!-- <button type="button" name="status_active" class="btn btn-primary Active" style="background-color:#004F7B">Change Status</button> -->
                        <?php
                          if($_SERVER['HTTP_HOST'] =='wgc33.vip' || $_SERVER['HTTP_HOST'] =='testing.jgdx.xyz')
                          {
                          ?>
                          <button type="submit" name="all_numbers_status_reset" onClick="confirm('Are you sure.You want to reset all number status.')" class="btn btn-primary" style="background-color:#004F7B">Reset All Status</button>
                        <?php
                          }
                          ?>
                      </form>
            ...
            <thead>
                    ...
                    <?php
                      ...
                      {
                      ?>
                      <!-- <th> <input type="checkbox" id="checkedall" class="checkall"> </th> -->
                      <?php
                      }
                      ?>
                      <th>#</th>
                ...
                // {
                 // $user_id_hwe    =   $result_user['user_id'];
                  ...
                  $no =1; //ramkishan
                  $select_user1 ="SELECT * from ".$table_prefix."phonenogenerate";
                  ...
                  ?>
                      <tr class="text-center">
                        ...
                        {
                        ?>
                        <!-- <td><input type="checkbox" class="checkbox" id="custom_<?php echo $id ?>" value="<?php echo $id ?>"></td> -->
                        <?php
                        }
                        ?>
                        <td><?php echo $no; ?></td>
                ...
                //  jQuery(".Active").click(function(){
                  ...
                  jQuery('.checkbox').each(function () {
                      ...
                      if (jQuery(this).is(":checked")) {
                          checked[item_number] = 0;

                          nre_array[key_hwe] = item_number;

                          key_hwe = parseInt(key_hwe) + parseInt(1)

                         // alert(nre_array);
                      } else {
                          checked[item_number] = 1;
                          
                      }
                    
                  });

                  //console.log("checked",nre_array);
                  //ajax code 
                  ...
                  jQuery.ajax({
                    ...
                    type: "POST",
                    data : {
                      checked:nre_array, status_active:"qwe"
                  }, 
