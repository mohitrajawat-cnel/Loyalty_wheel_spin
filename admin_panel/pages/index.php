        ...
        if($second_layout_sp == '1' || $fourth_layout_sp == '1')
        {
            ...
            if($_POST['wallpaper-config'] == '9')
            {
                ...
                if(isset($_FILES['live_wallpaper_img']['name']) && $_FILES['live_wallpaper_img']['name'] !='')
                {
                    ...
                    // $full_path = dirname(__FILE__).'/img/'.$get_host_hwe1.'live_wallpaper_img.png';
                    ...
                    $file_selector_tmp_name1 = $_FILES['live_wallpaper_img']['tmp_name'];
                        ...
                        // Compress Image
                    //compressImage($file_selector_tmp_name1,'img/'.$get_host_hwe1.'live_wallpaper_img.png',50);
...
// die("ghfghfg");
        ...
        for($i=0; $i<$total_slices_count; $i++)
        {
            if(isset($_FILES['slice'.$i]['name']) && $_FILES['slice'.$i]['name'] !='')
            {
                ...
                // $current_date_strtime = strtotime($current_date);
               ...
               // move_uploaded_file($slice0_tmpname,'img/'.$image_name);
                $objupload = new Image_converter();
                $objupload->upload_image($_FILES,$i,'img/');
               // compressImage($slice0_tmpname,'img/'.$image_name,60);
        ...
        {            
            ...
            {            
                ...
                // $data = json_decode($row['banner_image'],true);

                // array_push($array_push,$image);
                // $encode = json_encode($array_push);
                // if(count($data) > 0 )
                // {
                //    echo $sql="UPDATE banner_add SET banner_image='".$encode."'
                //     ";
        ...
        // if(isset($_FILES['slice0']['name']) && $_FILES['slice0']['name'] !='')
        // {
        //     $slice0 = $_FILES['slice0']['name'];
        //     $slice0_tmpname = $_FILES['slice0']['tmp_name'];
        //     $slice_hwe['slice0'] = 'img/reward0.png';
        //     move_uploaded_file($slice0_tmpname,'img/reward0.png');
        // }

        // if(isset($_FILES['slice1']['name']) && $_FILES['slice1']['name'] !='')
        // {
        //     $slice1 = $_FILES['slice1']['name'];
        //     $slice1_tmpname = $_FILES['slice1']['tmp_name'];
        //     $slice_hwe['slice1'] = 'img/reward1.png';
        //     move_uploaded_file($slice1_tmpname,'img/reward1.png');
        // }

        // if(isset($_FILES['slice2']['name']) && $_FILES['slice2']['name'] !='')
        // {
        //     $slice2 = $_FILES['slice2']['name'];
        //     $slice2_tmpname = $_FILES['slice2']['tmp_name'];
        //     $slice_hwe['slice2'] = 'img/reward2.png';
        //     move_uploaded_file($slice2_tmpname,'img/reward2.png');
        // }

        // if(isset($_FILES['slice3']['name']) && $_FILES['slice3']['name'] !='')
        // {
        //     $slice3 = $_FILES['slice3']['name'];
        //     $slice3_tmpname = $_FILES['slice3']['tmp_name'];
        //     $slice_hwe['slice3'] = 'img/reward3.png';
        //     move_uploaded_file($slice3_tmpname,'img/reward3.png');
        // }

        // if(isset($_FILES['slice4']['name']) && $_FILES['slice4']['name'] !='')
        // {
        //     $slice4 = $_FILES['slice4']['name'];
        //     $slice4_tmpname = $_FILES['slice4']['tmp_name'];
        //     $slice_hwe['slice4'] = 'img/reward4.png';
        //     move_uploaded_file($slice4_tmpname,'img/reward4.png');
        // }

        // if(isset($_FILES['slice5']['name']) && $_FILES['slice5']['name'] !='')
        // {
        //     $slice5 = $_FILES['slice5']['name'];
        //     $slice5_tmpname = $_FILES['slice5']['tmp_name'];
        //     $slice_hwe['slice5'] = 'img/reward5.png';
        //     move_uploaded_file($slice5_tmpname,'img/reward5.png');
        // }
        // if(isset($_FILES['slice6']['name']) && $_FILES['slice6']['name'] !='')
        // {
        //     $slice6 = $_FILES['slice6']['name'];
        //     $slice6_tmpname = $_FILES['slice6']['tmp_name'];
        //     $slice_hwe['slice6'] = 'img/reward6.png';
        //     move_uploaded_file($slice1_tmpname,'img/reward6.png');
        // }
        // if(isset($_FILES['slice7']['name']) && $_FILES['slice7']['name'] !='')
        // {
        //     $slice7 = $_FILES['slice7']['name'];
        //     $slice7_tmpname = $_FILES['slice7']['tmp_name'];
        //     $slice_hwe['slice7'] = 'img/reward7.png';
        //     move_uploaded_file($slice1_tmpname,'img/reward7.png');
        // }
        // if(isset($_FILES['slice8']['name']) && $_FILES['slice8']['name'] !='')
        // {
        //     $slice8 = $_FILES['slice8']['name'];
        //     $slice8_tmpname = $_FILES['slice8']['tmp_name'];
        //     $slice_hwe['slice8'] = 'img/reward8.png';
        //     move_uploaded_file($slice1_tmpname,'img/reward8.png');
        // }
        // if(isset($_FILES['slice9']['name']) && $_FILES['slice9']['name'] !='')
        // {
        //     $slice9 = $_FILES['slice9']['name'];
        //     $slice9_tmpname = $_FILES['slice9']['tmp_name'];
        //     $slice_hwe['slice9'] = 'img/reward9.png';
        //     move_uploaded_file($slice9_tmpname,'img/reward9.png');
        // }
        // if(isset($_FILES['slice10']['name']) && $_FILES['slice10']['name'] !='')
        // {
        //     $slice10 = $_FILES['slice10']['name'];
        //     $slice10_tmpname = $_FILES['slice10']['tmp_name'];
        //     $slice_hwe['slice10'] = 'img/reward10.png';
        //     move_uploaded_file($slice10_tmpname,'img/reward10.png');
        // }
        // if(isset($_FILES['slice11']['name']) && $_FILES['slice11']['name'] !='')
        // {
        //     $slice11 = $_FILES['slice11']['name'];
        //     $slice11_tmpname = $_FILES['slice11']['tmp_name'];
        //     $slice_hwe['slice11'] = 'img/reward11.png';
        //     move_uploaded_file($slice11_tmpname,'img/reward11.png');
        // }
    ...
    // else
    // {
    //       echo '<div style="text-align:center;">probability must be 100%</div>';
    // }
...
//    die("mohit");
    ...
    if($second_layout_sp == '1')
    {
        ...
        $home_menu_image='';
        $home_menu_image_checkbox=0;
        if(isset($spin_data['home_menu_image_checkbox']))
        {
            
            if(isset($spin_data['home_menu_image']))
            {
        ...
        $share_menu_image='';
        $share_menu_image_checkbox=0;
        if(isset($spin_data['share_menu_image_checkbox']))
        {
            if(isset($spin_data['share_menu_image']))
            {
        ...
        $message_menu_image='';
        $message_menu_image_checkbox=0;
        if(isset($spin_data['message_menu_image_checkbox']))
        {
           
            if(isset($spin_data['message_menu_image']))
            {
        ...
        $account_menu_image='';
        $account_menu_image_checkbox=0;
        if(isset($spin_data['account_menu_image_checkbox']))
        {
            if(isset($spin_data['account_menu_image']))
            {
...
//     $reward_icon_change = $spin_data['reward_icon_change'];
    ...
    $register_now=0;
    if(isset($spin_data['register_now']))
    {
...
//die("fgdf");
    ...
    $total_spin_show=0;
    if(isset($spin_data['total_spin_show']))
    {
    ...
    {
        if(isset($spin_data['no_matter_labal_image_hideshow'.$i]))
        {
    ...
    for($i =0; $i <$total_slices; $i++ )
    {
        ...
        if(isset($spin_data['slice_color_checkbox_'.$i]))
        {
        ...
        if(isset($spin_data['slice_text_color_'.$i]))
        {
            $slice_text_color_set[$i] = $spin_data['slice_text_color_'.$i];
        }
        else
        {
            $slice_text_color_set[$i] = '';
        }
        

        if(isset($spin_data['slice_text_color_checkbox_'.$i]))
        {
...
<style>
    ...
    <?php
          ...
          $param_js_file = 'js/params.js?v='.$current_time_hwe_strtotime;
    ...
    <script src="<?php echo $param_js_file; ?>" data-type="admin" defer></script>
