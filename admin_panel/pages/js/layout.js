...
jQuery(document).ready(function(){
        ...
        f = jQuery("#set_random_spin_value").val();
        //f = document.getElementById('set_random_spin_value').value;
            jQuery.ajax({
                        type: "POST",
                        ...
                        success:function(success)
                        {
                            ...
                            var reward = jQuery("#set_user_reward").val();
                            reward = document.getElementById('set_user_reward').value;
...
function spin_result_redeem_used_update(c, e)
{
    ...
    jQuery.ajax({
        type: "POST",
        url: "https://"+site_url+"/admin_panel/pages/send_ajax_data.php",
        data: { 
...
function renderImageReward(c, e, f, b,hwe=0) {
    ...
    var get_domain_name = document.domain;
        if(hwe==1)
        {
            var h = "img/"+get_domain_name+e+".png?v=" + new Date().getTime();
        }
        else
        {
            var h = "";
...
//     var default_image_hwe = '[{"value":"01$","imageUrl":"img/reward0.png"},{"value":"02$","imageUrl":"img/reward1.png"},{"value":"03$","imageUrl":"img/reward2.png"},{"value":"04$","imageUrl":"img/reward3.png"},{"value":"05$","imageUrl":"img/reward4.png"},{"value":"06$","imageUrl":"img/reward5.png"},{"value":"07$","imageUrl":"img/reward6.png"},{"value":"08$","imageUrl":"img/reward7.png"},{"value":"09$","imageUrl":"img/reward8.png"},{"value":"10$","imageUrl":"img/reward9.png"},{"value":"11$","imageUrl":"img/reward10.png"},{"value":"12$","imageUrl":"img/reward11.png"}]';
   ...
   // var get_ux = jQuery("#wheel-ux-config").find(":selected").val();;
    ...
    spinImage = c.image("img/"+get_domain+"brand.png", 160);
    ...
    var wheel_button_border_olor = jQuery("#wheel_button_border_olor").val();

    if(wheel_button_border_olor != '')
    {
        jQuery("#drawing circle").each(function(index){

                if(index == 2)
                {
                    jQuery(this).attr("fill",wheel_button_border_olor);
                }
        });
        ...
        for (h = 0; h < _globalVars.config.totalSlices; h++) {
            ...
            if ((-1 < _globalVars.jsonData[h].value.indexOf(" ")) || (-1 < _globalVars.jsonData[h].value.indexOf("+"))){
                    ...
                    b =
                        "3" === _globalVars.config.wheelUX
                            ? c.text(function (a) {
                                  a.tspan(get_labels_value_wheel_array[h]).font({ size: font_size_hwe, fill: l,anchor: "middle"});
                              })
                            : c.text(function (a) {
          ...
          // 12 === parseInt(_globalVars.config.totalSlices) && (b.opacity(0), renderImageReward(c, h, e.x1, e.y1,1));
