...
{ //ramkishan
  ...
  ?>
   <script>
    window.location.replace('mobile_number_username_list.php');
   </script>
  <?php
}
?>
            ...
            <div class="card-body px-0 pb-2">
              ...
              <div class="table-responsive p-0">
				...
				<?php
                  ...
                  $no =1;// ramkishan
                  $select_user1 ="SELECT * from ".$table_prefix."codegenerate where method='user_username_mobile' order by id desc";
                  $row_user1 = $conn->query($select_user1);
                  while($result_user1 = mysqli_fetch_assoc($row_user1))
                  {

                  $user_username_mob_meth_username    =   $result_user1['user_username_mob_meth_username'];
                  $user_username_mob_meth_mobnumber    =   $result_user1['user_username_mob_meth_mobnumber'];
                  ...
                  ?>
                      <tr class="text-center">
                        ...
                        <td><?php echo $user_username_mob_meth_mobnumber; ?></td>
                        ...
                        <td>
                          ...
                          <a href="../pages/mobile_number_username_list.php?id=<?php echo $id; ?>" ><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
