...
if(isset($_POST['delete_all_results']))
{
  ...
  ?>
   <script>
    window.location.replace('optimize_spin_results.php');
   </script>
  <?php
}
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <form method="post">
                  ...
                  <div class="row">
                    <div class="col-md-12 col-12 pt-2">
                      ...
                      ?>
                        ...
                        <a href="optimize_spin_results.php" target="_blank" style="background-color:#337ab7;float:right;" name="export_spin_result" class="btn btn-primary">Export Results</a>
                  ...
                  <thead>
                      ...
                      while($result_user = mysqli_fetch_assoc($row_user))
                      {
                        ...
                        { 
                            ...
                            {
                                $redeem_text = 'REDEEM';
                                  $redeem_button = '<a href="../pages/optimize_spin_results.php?redeem_id='.$id.'"><button type="button" class="btn btn-danger btn-sm">REDEEM</button></a>';
      ...
      echo ' <a class="hwe_ul"  href="optimize_spin_results.php?page=1&s='.$search_result.'">First</a>';

      if($page_number>1)
      {
        echo '<a class="hwe_ul"  href = "optimize_spin_results.php?page=' . $page_number - 1 . '&s='.$search_result.'">' . $page_number - 1 . ' </a>';
      }
      ...
      if($page_number<$totoalPages)
      {
       ...
       echo ' <a class="hwe_ul"  href="optimize_spin_results.php?page='.($totoalPages) .'&s='.$search_result.'">Last</a>';
