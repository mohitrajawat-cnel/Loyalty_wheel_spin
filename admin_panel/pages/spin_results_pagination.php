...
{//ramkishan
  ...
  ?>
   <script>
    window.location.replace('spin_results_pagination.php');
   </script>
  <?php
}
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <form method="post">
          ...
          ?>
                      ...
                      <tr class="text-center">
                        ...
                        { 
                            ...
                            {
                                $redeem_text = 'REDEEM';
                                  $redeem_button = '<a href="../pages/spin_results_pagination.php?redeem_id='.$id.'"><button type="button" class="btn btn-danger btn-sm">REDEEM</button></a>';
      ...
      echo ' <a class="hwe_ul"  href="spin_results_pagination.php?page=1&s='.$search_result.'">First</a>';

      if($page_number>1)
      {
        echo '<a class="hwe_ul"  href = "spin_results_pagination.php?page=' . $page_number - 1 . '&s='.$search_result.'">' . $page_number - 1 . ' </a>';
      }
      ...
      if($page_number<$totoalPages)
      {
       ...
       echo ' <a class="hwe_ul"  href="spin_results_pagination.php?page='.($totoalPages) .'&s='.$search_result.'">Last</a>';
