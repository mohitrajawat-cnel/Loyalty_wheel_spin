...
{ //ramkishan
  ...
  ?>
   <script>
    window.location.replace('user_email_method.php');
   </script>
  <?php
}
?>
            ...
            <div class="card-body px-0 pb-2">
              ...
              <div class="table-responsive p-0">
				...
				<?php
                  ...
                  $no =1;// ramkishan
                  $select_user1 ="SELECT * from ".$table_prefix."codegenerate where method='email' order by id desc";
                  $row_user1 = $conn->query($select_user1);
                  while($result_user1 = mysqli_fetch_assoc($row_user1))
                  {

                  $useremail    =   $result_user1['user_email_method_email'];
                  ...
                  ?>
                      <tr class="text-center">
                        ...
                        <td>
                          ...
                          <a href="../pages/user_email_method.php?id=<?php echo $id; ?>" ><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
