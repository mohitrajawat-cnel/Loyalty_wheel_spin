...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <?php
     ...
     // echo "SELECT * FROM ".$table_prefix."spin_result where 1=1".$like_query_for_search;
    ...
    <form method="post">
      <div class="container-fluid py-4">
          ...
          <div class="col-12">
            <div class="card my-4">
              ...
              <div>
                  ...
                  <thead>
                      ...
                      <tr class="text-center">
                        ...
                        { 
                          ...
                          else if($user_username_mobile_method == '1')
                          {
                  ...
                  $select_user="SELECT * FROM ".$table_prefix."spin_result where 1=1 && result_visible_status='1'".$like_query_for_search." order by id desc LIMIT ".$paginationStart.','.$limit;
        ...
        <!-- start code for export all results -->

        <?php
        
        $select_user="SELECT * FROM ".$table_prefix."spin_result where 1=1 && result_visible_status='1' order by id desc";
        $row_user = $conn->query($select_user);
        $no =1;
        $count_row =1;
        $user_arr=array();
        ...
        while($result_user = mysqli_fetch_assoc($row_user))
        {
          ...
          elseif($user_username_mobile_method)
          {  
      ...
      <!-- end code for export all results -->
      </form>
          ...
          <?php
                  ...
                  //   }
                      ...
                      // echo '<a href = "spin_results.php?page=' . $i . '">' . $i . ' </a>';
                          
                      //     }

                          // if($totoalPages > $page_number){
