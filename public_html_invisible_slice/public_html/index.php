        ...
        <script>
            ...
            //          }
                ...
                setTimeout(function(){
                    ...
                    if(code_login_function == '1' || code_function == '1' || code_mobile_function == '1' || user_email_method == '1' || user_n_e_mob_method == '1' || normal_spin_method == '1' || user_username_mobile_method == '1')
                    {
                                            ...
                                            if($share_referrel == '1' && (isset($_REQUEST['ref']) && $_REQUEST['ref'] !=''))
                                            {
                                                ...
                                                <!-- <div class="form-group" id="mobile_number_enter_box">
                                                    <div class="row show_in_center_mobile" style="display: flex;">
                                                        ...
                                                        <div class="col-sm-6 custom_add_margin_user" style="display:flex;">
                                                            <select name="country_code_share" id="country_code_share" style="width: auto;margin: 0px;margin-top: 10px;height: 34px;"><option value="60">+60</option></select><input type="number" name="user_mobile_number_share" class="form-control design_password" id="user_mobile_number_share" placeholder="Enter Mobile Number">
                                                        </div>
                                                        <div id="recaptcha-conatiner" style="visibility: hidden;"></div>
                                                    </div>
                                                </div> -->
                                                <!-- <div class="form-group" id="otp_enter_box" style="display:none;">
                                                    <div class="row show_in_center_mobile" style="display: flex;">
                                                        <div class="col-sm-4" style="text-align: right;padding: 20px;color: #ef8318;">
                                                            <label>Enter OTP</label>
                                                        </div>
                                                        <div class="col-sm-6 custom_add_margin_user" style="display:flex;">
                                                            <input type="number" name="user_otp_number_share" class="form-control design_password" id="user_otp_number_share" placeholder="Enter OTP">
                                                        </div>
