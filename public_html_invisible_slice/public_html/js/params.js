...
function setDefaultParams() {
    var d = JSON.parse(send_defaultConfig_json_data);
...
function setTotalSlices() {
    ...
    _globalVars.config.totalSlices = _globalVars.config.totalSlices;
    d = JSON.parse(send_reward_image_json_data);
...
function setSliceDetail() {
    var d = JSON.parse(send_reward_image_json_data);
    ...
    //     create_hwe.setAttribute("class", "form-control input-detail probability"+g);
...
function save() {
    ...
    var q = $("#wallpaper-config").val(),
        ...
        u = [],
        y = 0;
    var get_sound =   $("#get_bg_music").val();
    "1" === $("#sound-config").val() && x.push(get_sound);
    switch (q) {
        case "1":
...
$("#wallpaper-config").on("change", function (d) {
    d = JSON.parse(send_defaultConfig_json_data);
