          ...
          <div class="row"> 
             ...
             <div class="row"> 
                ...
                while($result_user = mysqli_fetch_assoc($row_user))
                {
                  ...
                  {
                    if($redeem_button_link != '')
                    {
                     
                      $redeem_button = '
                      <a href="?data-link='.urlencode($redeem_button_link).'&custom_id_hwe='.base64_encode($id).'" name="custom_link" class="btn btn-danger btn-sm btn-redeem-hwe" data-link="'.$redeem_button_link.'" data-custom_id="'.$id.'">REDEEM NOW</a>
...
<script>
        jQuery(document).ready(function () {
            jQuery('.custom_redirect').on("click",function(){
                // var id = jQuery(this).attr("data-custom_id");
