...
if(isset($_POST['save_spin_code']))
{
    ...
    else
    {
        ...
        <script>
            var spain_code1dsfsdfsd = '<?php echo $_SESSION['spain_code']; ?>';
        </script>
        <script>
            jQuery(document).ready(function(){
                    jQuery("#drawing").show();
                    ...
                    jQuery(".footer_ul").addClass("pointer_events_hwe");
                        ...
                        if($code_sp == '1')
                        {
                            ...
                            ?>
                                ...
                                if(count_code > 0)
                                {
                                   ...
                                   // var used_code = '<?php echo base64_encode($user_spin_code); ?>';
                                    //var front_url = '<?php echo Front_URL; ?>';
                                    //var used_code_result = '<div class="item" style="margin-top: 10px;"><a href="'+front_url+'/used_code_latest_rewards.php?code='+used_code+'" target="_blank" style="color: #fff;font-size: 20px;">View latest Rewards</a></div>';
                            ...
                            ?>    
                                ...
                                success:function(success)
                                {
                                    ...
                                    spin(function(data) {
                                        ...
                                        jQuery(".footer_ul").removeClass("pointer_events_hwe");
