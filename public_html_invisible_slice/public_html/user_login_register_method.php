...
if(isset($_POST['submit_form_redeem_user']))
{
        ...
        // $user_mobile_number_share=$_POST['user_mobile_number_share'];
        // $user_mobile_number_otp=$_POST['user_otp_number_share'];
        // $country_code_share=$_POST['country_code_share'];
        ...
        if($login_password == $login_confirm_password)
        {
            ...
            if(mysqli_num_rows($query1)==0)
            {
                ...
                {
                    $user_re_point=0;
                    $select5="select * from ".$table_prefix."user_table where id='".$_REQUEST['ref']."'";
                    ...
                    if(mysqli_num_rows($query15) > 0)
                    {
                        ...
                        $update_user = "UPDATE ".$table_prefix."user_table SET user_redeem_point='$user_redeem_point' where id='".$_REQUEST['ref']."'
                        ";
...
if(isset($maintenance_data['maintenance_mode']) && $maintenance_data['maintenance_mode'] == '1')
{
    ...
    $full_url_invisible_slice_image='';
    if(isset($background['invisible_slice_image']))
    {
        $invisible_slice_image =$background['invisible_slice_image'];
        $full_url_invisible_slice_image = Site_URL.'/'.$invisible_slice_image;
    }
    ...
    for($i =0; $i <$total_slices; $i++ )
    {
        ...
        if($background['slice_color_checkbox_'.$i] == 1)
        {
    ...
    <script>
        ...
        jQuery(document).ready(function(){
            ...
            setTimeout(function(){
                ...
                var user_login_method = '<?php echo $user_login_sp; ?>';
                var user_login_register_method = '<?php echo $user_login_register_method; ?>';
                ...
                if(user_login_method == 1 || user_login_register_method == 1)
                {
    ...
    <body style="background-color:<?php echo $bg_color; ?>">
        ...
        <input type="hidden" id="user_login_register_function" value='<?php echo $user_login_register_method; ?>' />
        ...
        <input type="hidden" id="invisible_image_slice_image" value='<?php echo $full_url_invisible_slice_image; ?>' />
    ...
    <!-- partial -->
        ...
        <div id="ads" data-type="admin">
                            ...
                            <form method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <?php
                                        ...
                                        if($register_now == '1' && ($user_login_sp == '1' || $user_login_register_method == 1))
                                        {
                                    ...
                                    <?php
                                            if($share_referrel == '1' && (isset($_REQUEST['ref']) && $_REQUEST['ref'] !=''))
                                            {
                                                ?>
                                                    ...
                                                    <!-- <button type="button" id="share_user_otp_check" name="share_user_otp_check" class="btn btn-info btn-block btn-round" onClick="sendOTP_hwe();">Sign Up</button>
                                                    <button type="button" style="display:none;"id="save_otp_share_redeem" onClick="varify_code();" name="save_otp_share_redeem" class="btn btn-info btn-block btn-round">Sign Up</button> -->
                                            ...
                                            else
                                            {
                                                ?>
                                                    ...
                                                    <button type="button" id="open_register_form" name="open_register_form" class="">Sign Up</button>
            ...
            <!-- end login modal -->
            <div class="modal" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="top:81px;">
                    <div class="popup-overlay"></div>
                    <div class="modal-dialog modal-dialog-centered" role="document" style="z-index: 10000;">
                        <div class="modal-content">
                            <style>
                            ...
                            <form method="post">
                                <div class="modal-header border-bottom-0">
                                    <button id="close_user_register_popup" type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                ...
                                <div class="modal-footer d-flex justify-content-center modal_footer">
                                    <?php
                                            ...
                                            {
                                                ?>
                                                    <button type="submit" id="save_register_form" name="save_register_form" class="btn btn-info btn-round">Sign Up</button>
                                                    <button type="button" id="sign_form_open" name="sign_form_open" class="btn btn-info btn-round">Sign In</button>
            ...
            $firebase_share_redeem_js_file_url = 'firebase_share_redeem.js?v='.$current_time_hwe_strtotime;
            ...
            ?>
                    ...
                    <script>
                            jQuery(document).ready(function(){
                                jQuery("#open_register_form").on('click',function(){
                                    jQuery("#loginModal").attr("style","display:none;");
                                    jQuery("#registerModal").attr("style","display:block;");
                                });
                                jQuery("#close_user_register_popup").on('click',function(){
                                    jQuery("#registerModal").attr("style","display:none;");
                                });
                                jQuery("#sign_form_open").on('click',function(){
                                    jQuery("#registerModal").attr("style","display:none;");
                                    jQuery("#loginModal").attr("style","display:block;");
            ...
            <script>
                ...
                function loadEvents() {
                    ...
                    _globalVars.elms.spin.on('click',function(event) {
        ...
        /***************** //CLICK AND RECEIVE REWARD EVENTS *****************/
            ...
            ?>
            <script src="<?php echo $firebase_share_redeem_js_file_url; ?>"></script>
    ...
    <?php
    if($_SERVER['REQUEST_URI'] == '/?test=invisible')
    {
