    ...
    <body>
        <table class="table table-striped table-responsive" id="example" style="width:100%" >
            ...
            <tbody>
                  ...
                  $select_user ="SELECT * from ".$table_prefix."redeem_reward_points_results where user_id='$user_id_session'";
                  ...
                  while($result_user = mysqli_fetch_assoc($row_user))
                  {
                    ...
                    $select_user1_redeem ="SELECT * from ".$table_prefix."reward_redeem_items where id='".$share_redeem_reward_id."'";
