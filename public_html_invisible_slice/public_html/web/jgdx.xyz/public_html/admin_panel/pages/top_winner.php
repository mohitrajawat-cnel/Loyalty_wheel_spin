...
if(isset($id) && $id !='')
{
  $delete ="DELETE from top_winner where id ='".$id."'";
...
if(isset($_POST['save_top_winner']))
{
    ...
    $insert ="INSERT into top_winner SET player_id = '".$player_id."',reward ='$reward'"; 
...
if(isset($_REQUEST['update_top_winner']))
{
    ...
    $sql = "UPDATE top_winner SET player_id='$player_id' , reward='$reward' WHERE id=$id";
          ...
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              ...
              if(isset($_REQUEST['itemedit']))
              {
                    ...
                    $top_winner_sql = "SELECT * FROM top_winner where id='$editid' ";
            ...
            <?php } ?>
              ...
              <div class="table-responsive p-0">
				...
				<?php
                  $no =1;
                  $select_user1 ="SELECT * from top_winner";
