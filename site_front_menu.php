...
if(isset($menu_data['account_menu_sidebar_text']) && $menu_data['account_menu_sidebar_text'] != '')
{
...
if(isset($menu_data['home_menu_image_checkbox']) && $menu_data['home_menu_image_checkbox'] == '1')
{
    ...
    $home_menu = '<a href="'.Front_URL.'" id="home_url" '.$open_in_new_window.'>
    <li >
...
<div id="mySidenav" class="sidenav" style="z-index: 999999;">
		  ...
		  <a href="<?php echo Front_URL; ?>">
            ...
            <?php echo $home_menu_text; ?>
          </a>

          <?php
           if($user_id_session != '' && $user_login_sp == '1')
            {

            ?>
            
		       <!-- <a href="all_lat est_reward.php"><i class="fa fa-spinner side_bar" aria-hidden="true"></i></i><?php echo $share_menu_sidebar_text; ?></a> -->
               
                <a type="submit" href="all_latest_reward.php"><i class="fa fa-spinner side_bar" aria-hidden="true"></i></i><?php echo $share_menu_sidebar_text; ?></a>
        ...
        if(isset($user_id_session) && $user_id_session != '')
        {
            ...
            if($result_hwe){
                while($row_hwe=mysqli_fetch_assoc($result_hwe))
                {
                    ...
                    if(isset($row_hwe['user_redeem_point']))
                    {
        ...
        <div class="custom_reamin_spin_show">
            ...
            <!-- <div><?php echo $user_id_label; ?>: <?php echo $userpassword_hwe1; ?></div> -->
...
//ramkishan
    ...
    if($share_content_title != "")
    {
     ...
     {
         $share_content_title_hwe = "Loyalty Wheel Spin";
         
     }
     
    //  if($share_menu_url !='')
    //  {
    //     $share_referrel_hwe1 = $share_menu_url ;
    //  }

     if($share_referrel == '1')
     {
        
        $refferal_id = base64_encode($user_id_session);
        $share_referrel_hwe1 = Front_URL.'?ref='.$refferal_id;
     }
