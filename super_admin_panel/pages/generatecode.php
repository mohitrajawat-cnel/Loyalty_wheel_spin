...
if(isset($id) && $id !='')
{
  $delete ="DELETE from codegenerate where id ='".$id."'";
...
if(isset($_POST['save_generate_code']))
{
    ...
    $insert ="INSERT into codegenerate SET generate_code = '".$generate_code."',
    status ='0',
              ...
              <div class="table-responsive p-0">
                ...
                // {
                 // $user_id_hwe    =   $result_user['user_id'];
                  ...
                  $no =1;
                  $select_user1 ="SELECT * from codegenerate";
                  ...
                  ?>
                      <tr class="text-center">
                        ...
                        <td>
                          ...
                          <a href="../pages/generatecode.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-danger btn-sm">Delete</button></a>
