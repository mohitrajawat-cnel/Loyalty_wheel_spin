...
function spin(c, e) {
    if (!localStorage.getItem("remainTime")) {
        ...
        jQuery.ajax({
            type: "POST",
            url: "/admin_panel/pages/send_ajax_data.php",
            data: { 
            ...
            success:function(data)
            {
               ...
               jQuery("#set_random_spin_value").val(data);
...
function drawGraphic() {
    ...
    _globalVars = {
        ...
        config: { wheelUX: "4", totalSlices: 12, distanceDeg: 45, defaultStartDeg: null, borderSlice: 5, sliceWidth: 30, graphicOption: 1, brandLogo: "img/"+get_domain+"brand.png", backgroundColor: "#337ab7", allowSound: !0 },
        elms: {
            container: c.group(),
            pizza: c.group(),
            pizzaArr: [],
    ...
    for (h = 0; h < _globalVars.config.totalSlices; h++) {
        ...
        if (12 >= parseInt(_globalVars.config.totalSlices))
         ...
         b = c.text(function (a) {
                            a.tspan(get_labels_value_wheel_array[h]).font({ size: font_size_hwe, fill: l });
             });
