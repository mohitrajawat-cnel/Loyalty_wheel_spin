...
$error="";
				...
				if(isset($_POST['sign_in']))
				{
				  ...
				  $select="select * from super_admin_login where username='$login_email' and password='$login_password'";
                ...
                $error='<span id="login-password-error" class="error">Please enter correct login details.</span>';
						...
						else
						{
							...
							while($row=mysqli_fetch_array($query))
							{
								...
								?>
                                <script>
										window.location.href='<?php echo Site_URL; ?>/domains.php';
								</script>
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1 text-center">
                  <h5 style="color: #fff;">Super Admin Login</h5>
                  <!-- <div class="row mt-3">
                  </div> -->
                </div>
              </div>
