...
if(isset($_POST['save_spin_code_mobile']) || isset($_POST['check_spin_code_mobile_otp']))
{
    ...
    if(isset($_POST['enter_otp_sent']) && $_POST['enter_otp_sent'] != '')
    {
        ...
        echo $select="select * from ".$table_prefix."phonenogenerate where mobile_otp='$enter_otp_sent' and status = '0'";
    }
    else
    {
        //ramkishan
                ...
                var get_otp_value_hwe='';
                    ...
                    setTimeout(function () {
                       ...
                       if(check_sound == 1)
                       {
                        ...
                        var check_opt_method = '<?php echo $mobile_num_otp; ?>';

                        if(check_opt_method != '1')
                        {
